...
def sshInstall(retry,hostname):
    ...
    try:
        ...
        wget --no-check-certificate https://github.com/insightfinder/InsightAgent/archive/groupid.tar.gz -O insightagent.tar.gz\n \
        tar xzvf insightagent.tar.gz\n \
        cd InsightAgent-groupid && python deployment/checkpackages.py\n")
