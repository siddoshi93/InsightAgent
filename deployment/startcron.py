...
def sshDeploy(retry,hostname):
    ...
    try:
        ...
        session.get_pty()
        command="cd InsightAgent-staging && sudo ./deployment/install.sh -i "+projectName+" -u "+userInsightfinder+" -k "+licenseKey+" -s "+samplingInterval+" -r "+reportingInterval+" -t "+agentType
