...
def get_args():
    ...
    parser.add_argument('-t', '--AGENT_TYPE', type=str, help='Agent type: proc or cadvisor or docker_remote_api or cgroup', choices=['proc', 'cadvisor', 'docker_remote_api', 'cgroup'],required=True)
